...
const ArgonFeature = () => {
  return (
    <div className="bg-cyan-100 rounded-lg my-20">
      <div className="p-8 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3">
        <div className="p-8">
          ...
          <Link className="text-indigo-500 flex items-center hover:text-indigo-600">
            More about us icon
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
        ...
        <div className="p-8">
          ...
          <Link className="text-green-500 flex items-center hover:text-green-600">
            More about us icon
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
        ...
        <div className="p-8">
          ...
          <Link className="text-red-500 flex items-center hover:text-red-600">
            More about us icon
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
