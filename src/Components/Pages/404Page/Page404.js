...
const Page404 = () => {
  return (
    <div className="lg:px-24 lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16 lg:mb-48">
        ...
        <div className="relative">
          <div className="absolute">
            <div className="">
              ...
              <p className="my-10 text-gray-800 mb-24">
